...
export default function IncidentForm() {
  ...
  const {
    ...
    token: usersToken,
    error: usersError,
  } = useFetchData("/api/v1/admin/users/staff");
  ...
  const getAssignedUserId = () => {
    return typeof ticket.assignedTo === "object" && ticket.assignedTo !== null
      ? ticket.assignedTo.id
      : ticket.assignedTo || "";
  };

  const staffId = getAssignedUserId();

  const updateData = async () => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/v1/tickets/${id}/assign/${staffId}`,
        {
          method: "PUT",
          headers: {
        ...
        <div className="container-fluid px-4">
          <div className="row align-items-center">
            ...
            <div className="col-auto">
              <button className="btn-sn-primary me-2 " onClick={updateData}>
                Update
              </button>
              ...
              <div className="mb-3 row">
                ...
                <div className="col-sm-7">
                  <select
                    ...
                    name="assignedTo"
                    className="form-select"
                    value={ticket.assignedTo?.id || ticket.assignedTo || ""}
                    onChange={handleChange}
                  >
              ...
              <div className="mb-3 row">
                ...
                <div className="col-sm-7">
                  <input
                    ...
                    id="createdAt"
                    className="form-control"
                    value={formattedDate(ticket.createdAt)}
                    disabled
                    readOnly
                  />
                </div>
              ...
              <div className="mb-3 row">
                ...
                <div className="col-sm-7">
                  <input
                    ...
                    id="updatedAt"
                    className="form-control"
                    value={formattedDate(ticket.updatedAt)}
                    disabled
                    readOnly
                  />
                </div>
